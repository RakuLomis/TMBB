...
def to_wireshark_filter(udp_ports, tcp_ports, current_time): 
    ...
    file_name = f"Papers\\UserPattern\\wireshark_order\\tshark\\{current_time}.txt"
...
if __name__ == "__main__": 
    ...
    pcap_directory = "wireshark_traffic\\tshark"
    device = 'WLAN'
    device_proxy = 'Meta'
    ...
    filter_order = to_wireshark_filter(all_udp_ports_set, all_tcp_ports_set, current_time=time)
